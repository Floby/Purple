...
namespace purple {
    class FileModule :public purple::BinaryModule {
	public:
	    virtual v8::Handle<v8::Object> getJsModuleObject() {
		v8::Handle<v8::Object> exports = v8::Object::New();
		v8::juice::cw::Installer<PosixFILE>::SetupBindings(exports);
		return exports;
	    }
    };
};

extern "C" purple::FileModule purple_module_file;
purple::FileModule purple_module_file = purple::FileModule();
